...
def union_blacken_data():
    ...
    homozygots_files_list = [os.path.join("all_soldiers", "homozygots",
                                          f"all_soldiers_astma_severity_easy_vs_hard_homozygot_{coef_or_pvalue}_seperate.xls"),
                  os.path.join("ashkenazim", "homozygots",
                               f"ashkenazim_astma_severity_easy_vs_hard_homozygot_{coef_or_pvalue}_seperate.xls")]
