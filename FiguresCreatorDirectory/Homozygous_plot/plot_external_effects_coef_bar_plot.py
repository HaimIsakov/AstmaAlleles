...
def get_external_effects_coef_df(coefs_file, pvalues_file, **kwargs):
    ...
    if len(labels) > 1:
        fig.legend(handles, labels, bbox_to_anchor=(0.7, 1), loc='upper right')
    # plt.savefig(row + "_" + kwargs["save_file_name"] + ".jpeg")
    plt.tight_layout()
...
if __name__ == "__main__":
    ...
    # kwargs = {"colors": ['purple', 'red'], "rot" : 45,
    ...
    # kwargs = {"colors": ['darkgreen', 'lime'], "rot" : 0,
    #           "prefixes": ["1", "2"],
    ...
    kwargs = {"colors": ['darkorange', 'gold'],"rot" : 0,
